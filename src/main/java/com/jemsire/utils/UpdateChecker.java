...
public final class UpdateChecker {
    ...
    private static final String GITHUB_API_URL =
            "https://api.github.com/repos/Jemsire/JemDeaths/releases/latest";

    private static final String GITHUB_RELEASES_URL =
            "https://github.com/Jemsire/JemDeaths/releases";

    private static final String USER_AGENT =
            "JemDeaths-UpdateChecker";
    ...
    private static final ExecutorService UPDATE_EXECUTOR =
            Executors.newSingleThreadExecutor(r -> {
                Thread t = new Thread(r, "JemDeaths-UpdateChecker");
                t.setDaemon(true);
                return t;
            });
    ...
    private void checkForUpdatesInternal() {
        try {
            ...
            if (isNewerVersion(latestVersion, currentVersion)) {
                ...
                Logger.info("JemDeaths is up to date! (Version: " + currentVersion + ")");
            }
        } catch (Exception e) {
    ...
    private void logUpdateAvailable(String latestVersion) {
        Logger.info("═══════════════════════════════════════════════════════════");
        Logger.info("A new version of JemDeaths is available!");
